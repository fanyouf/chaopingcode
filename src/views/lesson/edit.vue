...
<script setup lang="ts">
  import { add, getList } from '@/api/lesson'
  ...
  onMounted(async () => {
    ...
    if (id) {
      ...
      data.intro = res.data.intro // 介绍
      data.cover = res.data.cover // 封面
      data.targetOne = res.data.targetOne
      data.targetTwo = res.data.targetTwo
      data.targetThree = res.data.targetThree
      data.focus = res.data.focus // 教学重点
      data.difficulty = res.data.difficulty // 教学难点
      data.flowOne = res.data.flowOne // 教学流程1
      data.flowTwo = res.data.flowTwo // 教学流程2
      data.flowThree = res.data.flowThree // 教学流程3
      data.flowFour = res.data.flowFour // 教学流程4
      data.duration = res.data.duration // 教学时长
      data.order = res.data.order // 顺序
      data.ppt = res.data.ppt
      data.remark = res.data.remark // '备注'
      data.lessonTypeID = res.data.lessonTypeID // 教学分类类型ID

      data.productIDs = res.data.productIDs
      data.knowledgeIDs = res.data.productIDs
      data.questionIDs = res.data.productIDs
      // curSubject.value = {
